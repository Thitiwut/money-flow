	...
	<div class="container">
		...
		<form class="col-md-offset-3 col-md-6" method="post" action="register">
			...
			<div class="form-group">
				...
				<input type="password" class="form-control" id="password" placeholder="Password" name="password" pattern=".{6,}" title="6 characters minimum" value="{{old('password')}}" required>
			</div>
			<div class="form-group">
				<label for="repassword">Re-Password</label>
				<input type="password" class="form-control" id="repassword" placeholder="Re-Password" name="repassword" pattern=".{6,}" title="6 characters minimum" required>
			</div>
			<div class="col-md-12">
