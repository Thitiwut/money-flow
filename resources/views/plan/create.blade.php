        ...
        <div class="container">
            <div class="section col-md-6">
                ...
                <form method="POST" action="plan" >
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="pName" placeholder="Name" name="pname" value="<?php echo isset($plan) ? $plan->name : old('pname'); ?>" minlength="4" maxlength="10" required/>
                    </div>
                    <div class="form-group">
                        <label for="pDescription">
                            Description
                        </label>
                        <textarea  type="text" class="form-control" id="pDescription" placeholder="Description" name="pdescription" minlength="1" maxlength="30" required><?php echo isset($plan) ? $plan->description : old('pdescription'); ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="pTarget">
                            Target Money
                        </label>
                        <input type="text" class="form-control" id="pTarget" placeholder="Target" name="ptarget" value="<?php echo isset($plan) ? $plan->target : old('ptarget'); ?>" minlength="1" maxlength="6" required/>
                    </div>
                    <div class="form-group">
                        <label for="pBudget">
                            Budget
                        </label>
                        <input type="text" class="form-control" id="pBudget" placeholder="Budget" name="pbudget" value="<?php echo isset($plan) ? $plan->original : old('pbudget'); ?>" minlength="1" maxlength="5" required/>
                    </div>
                    <div class="form-group">
                        <label for="pMonth">
                            Duration
                        </label>
                        <input type="text" class="form-control" id="pMonth" placeholder="Per Month" name="pmonth" value="<?php echo isset($plan) ? $plan->period : old('pmonth'); ?>" minlength="1" maxlength="2" required/>
                    </div>
                    <div class="form-group has-warning">
                        <label for="pExpected">
                            Expected saving per month
                        </label>
                        <input type="number" class="form-control" id="pExpected" placeholder="Expected" name="pexpected" value="<?php echo isset($plan) ? $plan->expected : old('pexpected'); ?>" min="1" max="100000" required/>
                    </div>
                    <div class="text-center">
                        <div class="col-md-6">
            ...
            <div class="section col-md-6 plan_add_restrict">
                <form method="POST" action="plan/category" >
                    ...
                    <input type="text" class="form-control" id="cName" placeholder="New Category" name="cname" minlength="4" maxlength="10"/>
                    <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                ...
                <div class="section col-md-12 plan_add_restrict">
                    ...
                    <form method="POST" action="plan/restrict" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="rlimit" placeholder="Limitation amount" name="rlimit" minlength="1" maxlength="5"/>
                        </div>
                        <div class="text-center">
